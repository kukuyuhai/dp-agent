        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center">
            ...
            <div className="space-x-2">
              ...
              <Button onClick={handleBackToProjects} variant="outline">返回项目列表</Button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="w-64 bg-white border-r">
        <Sidebar className="h-full">
          ...
          <SidebarContent className="p-4">
            ...
            <div>
              <div className="mb-4">
                <h3 className="text-sm font-semibold text-gray-600 mb-1">项目</h3>
                <p className="text-sm font-medium">{project.name}</p>
              </div>

              <div>
                <h4 className="text-sm font-medium text-gray-600 mb-2">当前对话</h4>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500">
                项目: {project.name} • 创建于 {new Date(session.created_at).toLocaleString()}
              </p>
            </div>
